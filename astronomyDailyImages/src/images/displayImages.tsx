...
export const checkExistingFavourites = async(id : string) => {
    try {
        ...
        const response = await fetch("https://apodnasaimgfavourites.com/api/v1/nasa_data/" + id, 
            {
                method: 'GET',
                headers: {
...
export const storeData = async(image : imageData) => {
    ...
    try {
        const response = await fetch("https://apodnasaimgfavourites.com/api/v1/nasa_data", 
            {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
...
export const deleteData = async(image : imageData) => {
    try {
        const response = await fetch("https://apodnasaimgfavourites.com/api/v1/nasa_data/" + image.id, 
            {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
